...
class ContentAnalyticsPrivacyValidatorTests: XCTestCase {
    ...
    private func setHubStateWithConsent(registered: Bool) {
        ...
        mockRuntime.mockedSharedStates[ContentAnalyticsConstants.ExternalExtensions.EVENT_HUB] = SharedStateResult(status: .set, value: hubData)
    }
    ...
    private func setConsentState(value: String) {
        ...
        mockRuntime.mockedXdmSharedStates[ContentAnalyticsConstants.ExternalExtensions.CONSENT] = SharedStateResult(status: .set, value: consentData)
    }
    ...
    private func setMalformedConsentState() {
        ...
        mockRuntime.mockedSharedStates[ContentAnalyticsConstants.ExternalExtensions.CONSENT] = SharedStateResult(status: .set, value: consentData)
    }
